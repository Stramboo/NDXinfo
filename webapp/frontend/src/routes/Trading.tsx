...
export function Trading() {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 h-full">
      {/* 主 K 线 */}
      <section className="panel-card p-5 col-span-2 flex flex-col">
      ...
      <section className="panel-card p-5 flex flex-col">
        <h2 className="text-fg text-lg font-semibold mb-4">下单</h2>
        <OrderPanel symbol={symbol} />
        <hr className="my-5 border-line" />
        <h3 className="text-fg font-medium mb-3 text-sm">最近订单</h3>
